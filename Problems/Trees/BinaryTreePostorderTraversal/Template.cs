...
public class BinaryTreePostorderTraversalTemplate
{
    public void Solve()
    {
    ...
    {
        List<int> result = PostorderTraversalSolution(root);
    ...
    public List<int> PostorderTraversalSolution(TreeNode root)
    {
        // Your solution here
        return new List<int>();
    }
